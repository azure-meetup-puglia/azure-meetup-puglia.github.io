    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 font-sans">
      ...
      <div className="p-4 md:p-8">
        ...
        <main id="main-content" className="max-w-6xl mx-auto space-y-16 px-4">
          ...
          {/* Featured Event - Global Azure Puglia 2026 */}
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-4 mb-6">
                    <div className="flex items-center gap-2 text-gray-300">
                      ...
                      <span className="text-sm">17 Aprile 2026</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-300">
                      <MapPin className="w-4 h-4 text-green-400" aria-hidden="true" />
                      <span className="text-sm">Bari, Italia</span>
                    </div>
                    <div className="flex items-center gap-2 text-gray-300">
                      <Users className="w-4 h-4 text-purple-400" aria-hidden="true" />
          ...
          {/* GitHub Sessions Repository */}
          <section className="bg-gray-800 border border-gray-700 p-8 rounded-xl">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white mb-2">Materiali delle Sessioni</h2>
                  <p className="text-gray-400">
                    Trovi slide, demo e codice degli eventi sul nostro repository GitHub dedicato alle sessioni.
                  </p>
                </div>
              </div>
              <a
                href="https://github.com/azure-meetup-puglia/eventi-meetup"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gray-900 hover:bg-gray-700 text-white font-semibold rounded-lg border border-gray-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-gray-800 whitespace-nowrap"
                aria-label="Vai al repository GitHub delle sessioni"
              >
