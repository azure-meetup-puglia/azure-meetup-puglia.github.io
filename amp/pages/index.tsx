            ...
            <div className="relative z-10 p-6 md:p-8">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div className="flex-1">
                  <span className="inline-block px-3 py-1 bg-green-600/80 text-white text-xs font-semibold rounded-full mb-3 uppercase tracking-wider">
                    Evento Concluso · Grazie!
                  </span>
                  ...
                  <p className="text-gray-200 mb-3 max-w-2xl">
                    Grazie a tutte e tutti! Speaker, sponsor, partecipanti e volontari: avete reso speciale la prima edizione di Global Azure in Puglia. È stata una giornata intensa di tecnologia, confronto e community.
                  </p>
